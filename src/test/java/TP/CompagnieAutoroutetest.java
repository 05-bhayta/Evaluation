...
public class CompagnieAutoroutetest {
    ...
    void testObtenirTarifCalculé() {
        ...
        Collections.sort(r1.portes, new OrderPorteComparator());

        tarif t12 = new tarif(p1, p2, new BigDecimal("1E+1"));        
        tarif t23 = new tarif(p2, p3, new BigDecimal("2E+1"));
        tarif t34 = new tarif(p3, p4, new BigDecimal("3E+1"));
